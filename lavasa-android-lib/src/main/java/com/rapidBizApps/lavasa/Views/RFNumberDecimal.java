 ...
 */
public class RFNumberDecimal extends RFEditText {

    private MaterialEditText mMaterialEditText;

    public RFNumberDecimal(Context context, RFElementModel elementModel) {
    ...
    public void init() {
        mMaterialEditText.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL);
    }
